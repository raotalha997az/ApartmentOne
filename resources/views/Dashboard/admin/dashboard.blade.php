...
@section('scripts')
    <script>
        ...
        //     fetch(`admin/search-users?search=${query}`)
        //         .then(response => response.json())
        //         .then(data => {
        //             const tableBody = document.querySelector('.user-panel-list-box table');
        //             let rows = `
    //                 <tr>
    //                     <th>Users</th>
    //                     <th>Role</th>
    ...
    //                             <td>
    //                                 <div class="user-role">
    //                                     <p>${user.roles.includes('land_lord') ? 'Landlord' :
    //                                         user.roles.includes('tenant') ? 'Tenant' :
    //                                         user.roles.includes('admin') ? 'Admin' : 'Null'}</p>
    //                                 </div>
    //                             </td>
    //                             <td>
    //                                 <div class="user-country">
