                    ...
                    <tbody>
                        @foreach ($categorys as $category)
                            ...
                            <tr>
                                {{-- <td>{{ $category->id ?? '' }}</td> --}}
                                <td>{{ $category->name ?? '' }}</td>
                                <td><img src="{{ asset($category->image ?? 'default.png') }}" alt=""
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" data-bs-dismiss="modal" aria-label="Close"><svg width="40" height="41"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="upload-container" id="uploadBox">
                                <div class="upload-text" id="uploadText">
                                    <img src="{{ asset('assets/new-images/bx-cloud-upload.svg.png') }}" alt="upload icon"
                                        width="50">
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="itemForm" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn t-btn-blue-shade btn btn-primary"><svg width="20"
...
@section('scripts')
                    ...
                    success: function(response) {
                        ...
                        if (response.category) {
                            ...
                            if (response.category.image_url) {
                                ...
                                $('#dynamicImage').attr('src', response.category.image_url);
                            } else {
                                $('#old-image').attr('src', ''); // Clear image if none exists
                                $('#dynamicImage').attr('src', ''); // Clear image if none exists
                            }
    ...
    <script>
        function saveCategory() {
            ...
            const image = $('#newFileInput')[0]?.files[0]; // Use the correct id for the file input
