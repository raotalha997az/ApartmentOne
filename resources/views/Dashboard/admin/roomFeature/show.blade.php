...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="profile-basic-info-form">
                    ...
                    <a class="t-btn t-btn-blue-shade" href="javascript:void(0)" data-toggle="modal" data-target="#add-new-room-and-feature-Modal"><svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15.8337 9.84148H10.8337V4.84148H9.16699V9.84148H4.16699V11.5081H9.16699V16.5081H10.8337V11.5081H15.8337V9.84148Z" fill="white"/>
                        </svg>
                        Add New</a>
                </div>
  ...
  <div class="modal fade" id="edit-room-and-feature-Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="two-things-align">
            <button type="button" class="t-btn-blue-shade"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="modal fade" id="add-new-room-and-feature-Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
            <input type="text" placeholder="Rooms & Features">
        </div>
        <div class="two-things-align">
            <button type="button" class="t-btn-blue-shade"><svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.8337 9.84148H10.8337V4.84148H9.16699V9.84148H4.16699V11.5081H9.16699V16.5081H10.8337V11.5081H15.8337V9.84148Z" fill="white"/>
                </svg>
